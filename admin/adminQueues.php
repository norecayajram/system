...
include("../connection.php");
    ...
    $topay = mysqli_query($conn, "SELECT * FROM topay");
                                ...
                                <div>
                                    <form action="" method="post">
                                        <table width="98%" style="margin: 110px 0 30px 18%">
                                            ...
                                            <tr>
                                                <th colspan=""><button id="showProcess">To process</button></th>
                                                <div class="popupProcess" id="popupProcess">
                                                    <div class="box">
                                                        <h2>Mark as to process?</h2>
                                                        <div class="btn">
                                                            <button id="no">Cancel</button>
                                                            <button id="yes" name="to-process">Confirm</button>
                                                        </div>
                                                    </div>
                                                </div>
