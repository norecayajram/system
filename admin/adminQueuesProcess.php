...
include("../connection.php");
    ...
    $toprocess = mysqli_query($conn, "SELECT * FROM toprocess"); 

    $toprocess2 = mysqli_query($conn, "SELECT * FROM toprocess");
    if ($toprocess2 && mysqli_num_rows($toprocess2) > 0) {
        $rowss = mysqli_fetch_assoc($toprocess2);
        $_SESSION['process_id'] = $rowss['process_id'];
    } else {
            ...
            <div class="header">
                ...
                <div class="queuesOrders" id="queuesOrders">
                    <div class="queuesOrders-content">
                        <h1>Queues</h1>
                        <p>Queues <span>></span> To Process</p>
                    </div>
                    <center>
                        <?php
                                while ($row3 = mysqli_fetch_assoc($toprocess)) {
                            ?>
                                <div>
                                    <form action="" method="post">
                                        <table width="98%" style="margin: 110px 0 30px 18%">
                                            ...
                                            <tr>
                                                <th colspan=""><button id="showProcess">To ship</button></th>
                                                <div class="popupProcess" id="popupProcess">
                                                    <div class="box">
                                                        <h2>Mark as to ship?</h2>
                                                        <div class="btn">
                                                            <button id="no">Cancel</button>
                                                            <button id="yes" name="to-ship">Confirm</button>
                                                        </div>
                                                    </div>
                                                </div>
