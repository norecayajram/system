<?php 
  include("../connection.php");
    ...
    if(isset($_SESSION['valid'])){
        ...
        $query = mysqli_query($conn, "SELECT * FROM received WHERE customer_id = '$customer_id'");

        if(isset($_POST['submit'])){
            $search = $_POST['search'];

            $query = mysqli_query($conn, "SELECT * FROM received WHERE customize_product = '$search'");
        }
...
<head>
    ...
    <title>Received | Print My Shirt</title>
</head>
<body>
    ...
    <div class="content">
        <ul class="content-header">
            ...
            <a href="orders-received.php" class="active"><li>Received</li></a>
        ...
        <form action="" method="post">
            <?php while($row = mysqli_fetch_assoc($query)){ ?>
                    <table width="95%" style="margin-bottom: 30px;">
                        <tr>
                            <th colspan="100%"><h1>Received</h1></th>
                        </tr>
                        <tr>
                            <th>Reference ID</th>
