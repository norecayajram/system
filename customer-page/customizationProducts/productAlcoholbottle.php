...
<body>
   ...
   <?php
     if(isset($_GET['catalog_id'])){
        ...
        $query = mysqli_query($conn, "SELECT * FROM product_catalog WHERE catalog_id = $catalog_id");
...
<section>
        <div class="section-header">
            <h1><span><a href="../userpage.php">Home</a></span> > Alcohol Bottle</h1>
        </div>
    ...
    <div class="content">
        ...
        <div class="section-left-image">
            ...
            <div class="display-image">
                    <img src="<?= $row['catalog_image']; ?>" alt="" id="displayImage">
            </div>

        </div>

        <div class="section-right-content">
            <h1><?= $row['catalog_name']; ?></h1>
