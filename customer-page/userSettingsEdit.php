<?php
    ...
    if(isset($_POST['confirm'])){
        if(isset($_GET['address_id'])){
            ...
            mysqli_query($conn, "UPDATE customer_address SET
                    names = '$name',
                    phone_number = '$phone',
                    address = '$address',
                    city = '$city',
                    ...
                    mysqli_query($conn, "INSERT INTO audit_rel(customer_id,email,username,customer_actions) VALUES('$customer_id','$email','$usernames','Edited Address')");
